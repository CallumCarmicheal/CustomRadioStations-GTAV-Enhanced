...
namespace CustomRadioStations
{
    public static class RadioNativeFunctions
    {
        ...
        {
            try { return Function.Call<int>(Hash.GET_PLAYER_RADIO_STATION_INDEX); }
            catch { return 255; }
        }
        ...
        {
            try { return Function.Call<string>(Hash.GET_RADIO_STATION_NAME, index); }
            catch (Exception ex)
            {
        ...
        {
            try { return Function.Call<bool>(Hash.IS_MOBILE_PHONE_RADIO_ACTIVE); }
            catch { return false; }
        }
        ...
        static string _GET_LABEL_TEXT(string text)
        {
            ...
            try { return Function.Call<string>((Hash)0x7B5280EBA9840C72, text) ?? string.Empty; }
            catch { return text; }
        }
    }
}
